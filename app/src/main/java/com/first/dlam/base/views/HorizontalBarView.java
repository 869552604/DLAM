...
import com.first.dlam.base.fragment.Fragment1_4;
...
public class HorizontalBarView extends View {
    ...
    protected void onDraw(Canvas canvas) {
        ...
        for (int i = 0; i < hoBarEntityList.size(); i++) {
            ...
            //绘制bar
            if(hoBarEntityList.get(i).content.equals(Fragment1_4.key.toString())){
...
//        maxCount=0;
    ...
    public static class order implements Comparator<HoBarEntity> {

        @Override
        public int compare(HoBarEntity lhs, HoBarEntity rhs) {

            return  new Double(rhs.content).compareTo(new Double(lhs.content));
        }
